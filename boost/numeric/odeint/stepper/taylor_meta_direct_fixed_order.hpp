...
public:
    ...
    struct stepper
    {
    	...
    	: m_derivs() , m_dt_fac( value_type( 1.0 ) ) ,
    	  m_rel_error( rel_error ) , m_abs_error( abs_error ) ,
    	  m_trees( boost::fusion::as_vector( boost::fusion::transform( sys ,
    	          taylor_detail::tree_generator< taylor_detail::tree_nodes_v1::node_factory >() ) ) )
    	{
    ...
    private:
    	...
    	typedef typename boost::fusion::result_of::transform< const System , taylor_detail::tree_generator< taylor_detail::tree_nodes_v1::node_factory > >::type transformed_type;

...
public:
	...
	void do_step( System sys , const state_type &in , time_type &t , state_type &out , time_type &dt )
	{
		...
		typedef typename fusion::result_of::transform< const System , tree_generator< tree_nodes_v1::node_factory > >::type transformed_type;
		typedef typename fusion::result_of::as_vector< transformed_type const >::type tree_type;
		tree_type trees = fusion::as_vector( fusion::transform( sys , tree_generator< tree_nodes_v1::node_factory >() ) );
